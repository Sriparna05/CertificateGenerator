        ...
        <div className="max-w-6xl mx-auto text-center">
          <div className="animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
              ...
              Upload your data, choose a template, and generate beautiful PDFs automatically.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              ...
              <Button variant="outline" size="lg" className="text-lg px-8 py-6 h-auto hover:bg-primary/10 hover:border-primary transition-all duration-300 hover:scale-105">
                View Templates
              </Button>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="group hover:scale-105 transition-all duration-300 cursor-pointer">
              <div className="text-3xl font-bold bg-gradient-tech bg-clip-text text-transparent mb-2">10,000+</div>
              <div className="text-muted-foreground group-hover:text-foreground transition-colors duration-300">Certificates Generated</div>
            </div>
            <div className="group hover:scale-105 transition-all duration-300 cursor-pointer" style={{ animationDelay: '0.1s' }}>
              <div className="text-3xl font-bold bg-gradient-tech bg-clip-text text-transparent mb-2">50+</div>
              <div className="text-muted-foreground group-hover:text-foreground transition-colors duration-300">Professional Templates</div>
            </div>
            <div className="group hover:scale-105 transition-all duration-300 cursor-pointer" style={{ animationDelay: '0.2s' }}>
              <div className="text-3xl font-bold bg-gradient-tech bg-clip-text text-transparent mb-2">99.9%</div>
              <div className="text-muted-foreground group-hover:text-foreground transition-colors duration-300">Uptime Reliability</div>
            </div>
          </div>
        </div>
      </div>
